...
SDL_AppResult SDL_AppInit(void **appstate, int argc, char *argv[])
{
    ...
    *appstate = as;
    as->window = SDL_CreateWindow("examples/demo/snake", SDL_WINDOW_WIDTH, SDL_WINDOW_HEIGHT, SDL_WINDOW_RESIZABLE);
    as->renderer = SDL_CreateRenderer(as->window, "opengles2");
